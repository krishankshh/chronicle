...
<center>
 ...
 <table width="200" border="1"  id="example" class="table table-striped table-bordered" cellspacing="0">
  <tbody>
    <tr>
      <th scope="col">      
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <div class="input-group">
                                    <input type="text" class="form-control" name="grptextmsg" id="grptextmsg" placeholder="Enter Message" onKeyUp="submitgroupchat(coursetitle.value,semester.value,grptextmsg.value,event)" />
                                    <span class="input-group-btn">
                                        <button class="btn btn-info" type="button" onClick="submitgroupchatbtn(coursetitle.value,semester.value)">Emojis</button>
                                    </span>
                                </div>
            </div>
        </div>
