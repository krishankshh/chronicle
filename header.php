  ...
  <header id="header">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <a href="index.php" class="logo"><img src="images/malogo.jpg" alt="" style="height:100px;" align="left"><img src="images/chrlogo.jpg" alt="" style="height:100px;" align="left"></a>
        </div>
      </div>
    </div>
  </header>
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Profile</a>
            <ul class="dropdown-menu" role="menu">
		  	...
		  	?>
                      ...
                      <li><a href="addbyexcel.php">Add Student By Excel</a></li>
          	<?php
			}
			?>
            </ul>
