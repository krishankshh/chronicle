  ...
  <header id="header">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <a href="index.php" class="logo"><img src="images/malogo.jpg" alt="" style="height:100px;" align="right"><img src="images/chrlogo.jpg" alt="" style="height:100px;" align="centre"></a>
        </div>
      </div>
    </div>
  </header>
