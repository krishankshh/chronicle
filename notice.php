        ...
        <div class="left_content">
          <div class="contact_area">
            ...
            <option value="">Select</option>
              ...
              <textarea name="description" id="descriptions" class="form-control" cols="30" rows="10" placeholder="description *" tabindex="3"><p><?php echo strip_tags(substr($rsedit['description'], 0, 500)); ?></p></textarea>
