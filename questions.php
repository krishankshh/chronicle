        ...
        <div class="left_content">
          <div class="contact_area">
            ...
            <input  type="hidden" name="sessionid" value="<?php echo $_SESSION['sessionid']; ?>" >
              ...
              <input name="option1" class="form-control" type="text" placeholder="option1 *" value="<?php echo $rsedit[option1]; ?>">
               <span id="idoption1"></span>
              <br />
              Option 2:<font color='red' size='4'><strong>*</strong></font>
              <input name="option2" class="form-control" type="text" placeholder="option2 *" value="<?php echo $rsedit[option2]; ?>">
               <span id="idoption2"></span>
              <br />
              Option 3:<font color='red' size='4'><strong>*</strong></font>
              <input name="option3" class="form-control" type="text" placeholder="option3 *" value="<?php echo $rsedit[option3]; ?>">
               <span id="idoption3"></span>
              <br />
              Option 4:<font color='red' size='4'><strong>*</strong></font>
              <input name="option4" class="form-control" type="text" placeholder="option4 *" value="<?php echo $rsedit[option4]; ?>">
