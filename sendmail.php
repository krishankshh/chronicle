...
{
	$loginid 	= "krishankshh54@gmail.com";
	$password 	= "finnbalor78";
	$smtpserver = "smtp.gmail.com";
	$smtpport 	= 465;
	$mailsender = $_SESSION['chronicle'];
	$companyname= $_SESSION['chronicle'];
	$facebook = "https://www.facebook.com";
	$twitter = "https://www.twitter.com";
	$youtube = "https://www.youtube.com";
	$linkedin = "https://www.linkedin.com";
	$companyaddress  = $_SESSION['chronicle'] . ", A/1403, Madhupuri Apts, Kandivali (W) Email : krishankshh54@gmail.com";
	$contactno = "+91 8850622122";
	$url = "chronicle.com";
