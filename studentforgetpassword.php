...
if(isset($_POST['submit']))
{
	...
	if(mysqli_num_rows($qsql) == 1)
	{
		...
		$msg = "<a href='http://localhost/SourceCode/stchangepasswordst.php?stid=$rs[student_id]&sessionid=$_SESSION[sessionid]'>Recover password</a>";
		sendmail($rs['email_id'],"Password Recovery Mail..",$msg,$rs['student_name']);
	}
	else
	{
