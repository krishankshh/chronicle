 ...
 while($rsrec = mysqli_fetch_array($qsql))
  {
	  ...
	  echo "<tr>
        ...
        if($_SESSION['user_type'] == "Staff")
		   {
		echo "<a href='questions.php?quizid=$rsrec[quiz_id]'><font color='Red'>Add question</font></a><br />";
		   }
		   echo "<a href='viewquestions.php?quizid=$rsrec[quiz_id]'><font color='Blue'>View question</font></a><br /> ($rscount[0] questions) </td>
		<td>&nbsp;";
